            ...
            <div class="row g-0">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('articles.topics',['category' => 'Community', 'subcategory' => 'General-discussion' ]) }}"
                       class="text-decoration-none" style=" display: inline-block;margin-right: 5%">General
                        discussion</a>
                    <a href="{{ route('articles.topics',['category' => 'Community', 'subcategory' => 'Events-and-fan-creations' ]) }}"
                       class="text-decoration-none"  style=" display: inline-block;margin-right: 5%">Events
                        and fan creations</a>
                </div>
